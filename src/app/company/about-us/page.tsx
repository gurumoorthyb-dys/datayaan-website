...
export default async function AboutUsPage() {
  const [aboutData, whatWeDoData, domainsData, journeyData, whyData] =
    await Promise.all([
      fetchStrapiData("/about-page"),
      fetchStrapiData("/what-we-dos?sort=order:asc"),
      fetchStrapiData("/domains?sort=name:asc"),
      fetchStrapiData("/journey-milestones?sort=order:asc"),
      fetchStrapiData("/why-datayaans?sort=order:asc"),
    ]);
              ...
              {journey.map((milestone: any, idx: number) => (
                ...
                >
                  <div className="flex-1 w-full md:w-auto text-center md:text-left">
                    <div
                      className={`bg-neutral-800 p-8 rounded-2xl border border-neutral-700 hover:border-primary transition-colors duration-300 ${
                    ...
                    >
                      ...
                      <div
                        className={`text-neutral-400 space-y-2 ${
                          idx % 2 === 0 ? "" : "flex flex-col items-end"
                        }`}
                      >
